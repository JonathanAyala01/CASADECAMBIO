  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 space-y-6">
      ...
      <div className="bg-gradient-to-r from-slate-300 via-slate-200 to-slate-300 text-slate-900 p-5 rounded-2xl shadow-md border border-slate-400 space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3 text-xs text-slate-800 pt-1">
          <div className="bg-slate-100/90 p-3 rounded-xl border border-slate-400/80 shadow-sm space-y-1">
            <span className="text-emerald-900 font-black block">1. Captura Selfie Facial</span>
            <p className="text-[11px] text-slate-700 font-medium">
              Cada marcaje exige o captura una foto del rostro en tiempo real. Si un compañero usa la clave de otro, su cara queda registrada en la auditoría.
            </p>
          </div>
          ...
          <div className="bg-slate-100/90 p-3 rounded-xl border border-slate-400/80 shadow-sm space-y-1">
            <span className="text-emerald-900 font-black block">4. Auditoría con Fotos</span>
            <p className="text-[11px] text-slate-700 font-medium">
              La tabla de registros del Administrador incluye foto facial e indicador de distancia GPS por cada ingreso diario.
            </p>
          </div>
        </div>
      </div>
